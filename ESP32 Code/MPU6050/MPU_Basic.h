...
typedef enum {
    ACCELEROMETER_FS_RANGE_2G,
    ACCELEROMETER_FS_RANGE_4G,
    ACCELEROMETER_FS_RANGE_8G,
    ACCELEROMETER_FS_RANGE_16G
} acc_FS_range;

typedef enum {
    GYRO_FS_RANGE_250DPS,
    GYRO_FS_RANGE_500DPS,
    GYRO_FS_RANGE_1000DPS,
    GYRO_FS_RANGE_2000DPS
} gyro_FS_range;
